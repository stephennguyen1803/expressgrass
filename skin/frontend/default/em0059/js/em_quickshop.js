...
jQuery(function($)
{
	...
	function _qsJnit()
	{
		...
		$.each(listprod, function(index, value)
		{
			...
			var new_url = baseUrl.replace("index.php/", "");
			reloadurl = new_url + "/path/" + prodHref;
			version = ieVersion();
	...
	_qsJnit(
	{
		itemClass: '.products-grid li.item ,.products-list li.item ,.crosssell-products-list li.item ,.jcarousel-skin-tango li.item',
