...
class EM_Themeframework_Model_Status extends Varien_Object
{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('themeframework')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('themeframework')->__('Disabled')
        );
    }
}