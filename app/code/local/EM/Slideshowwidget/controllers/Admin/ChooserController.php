<?php
class EM_Slideshowwidget_Admin_ChooserController extends Mage_Adminhtml_Controller_Action
{
    public function chooserAction()
    {
    	...
    	$html =$this->getLayout()->createBlock('slideshowwidget/content')->toHtml();
    ...
    public function uploadAction()
    {
        ...
        try {
            ...
            $result = $uploader->save(
                Mage::getBaseDir('media') . DS . 'slideshow'
            );
    ...
    {
        return Mage::getBaseUrl('media') . 'slideshow';
    }
