...
class EM_Blog_Adminhtml_PostController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        switch ($this->getRequest()->getActionName()) {
            case 'new':
            case 'save':
                return Mage::getSingleton('admin/session')->isAllowed('cms/post_manager/save');
                break;
            case 'delete':
                return Mage::getSingleton('admin/session')->isAllowed('cms/post_manager/delete');
                break;
            default:
                return Mage::getSingleton('admin/session')->isAllowed('cms/post_manager');
                break;
        }
    }
