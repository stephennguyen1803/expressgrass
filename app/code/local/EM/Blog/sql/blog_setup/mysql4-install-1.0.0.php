...
$installer = $this;
$pathFile = Mage::getBaseDir('var').DS.'install_emblog.txt';
if(file_exists($pathFile)){
    echo 'Installing EM Blog, please come back in some minutes ...';
    exit;
}
file_put_contents($pathFile,'Installing EM Blog');
