<?php
class EM_Blog_Block_Adminhtml_Category_Edit_Form extends EM_Blog_Block_Adminhtml_Category_Abstract
{
	/**
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('tabs',
            $this->getLayout()->createBlock('blog/adminhtml_category_tabs', 'tabs')
        );
    ...
    public function getHeader()
    {
        if ($this->hasStoreRootCategory()) {
            if ($this->getCategoryId()) {
                ...
                if ($parentId && ($parentId != EM_Blog_Model_Category::TREE_ROOT_ID)) {
    ...
    public function getProductsJson()
    {
        ...
        if (!empty($posts)) {
            return Mage::helper('core')->jsonEncode($posts);
        }
        return '{}';
    }
