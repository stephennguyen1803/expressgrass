<?php
class EM_Blog_Block_Adminhtml_Category_Tree extends EM_Blog_Block_Adminhtml_Category_Abstract
{
    ...
    {
        return EM_Blog_Model_Abstract::DEFAULT_STORE_ID;
    }
	...
	public function getCategoryCollection()
    {
        ...
        if (is_null($collection)) {
            ...
            /* @var $collection EM_Blog_Model_Resource_Eav_Mysql4_Category_Collection */
            ...
            $this->setData('cat_collection', $collection);
        }
        return $collection;
    }
    ...
    {
        return $this->getUrl("*/category/tree", array('_current'=>true, 'store'=>null, '_query'=>false, 'id'=>null, 'parent'=>null));
    }
    ...
    public function getBreadcrumbsJavascript($path, $javascriptVarName)
    {
        ...
        $categories = Mage::getResourceSingleton('blog/category_tree')
