<?php
class EM_Blog_Block_Adminhtml_Tagblog_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
      $this->addTab('tag', array(
          ...
          'content'   => $this->getLayout()->createBlock('blog/adminhtml_tagblog_edit_tab_form')->toHtml(),
      ));
      
      $this->addTab('design', array(
          'label'     => Mage::helper('blog')->__('Design'),
          'title'     => Mage::helper('blog')->__('Design'),
          'content'   => $this->getLayout()->createBlock('blog/adminhtml_tagblog_edit_tab_Design')->toHtml(),
      ));
