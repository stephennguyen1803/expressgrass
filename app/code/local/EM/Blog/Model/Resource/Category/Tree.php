<?php
class EM_Blog_Model_Resource_Category_Tree extends Varien_Data_Tree_Dbp
{
	const ID_FIELD    = 'id';
    ...
    public function __construct()
    {
        ...
        parent::__construct(
            ...
            $resource->getTableName('blog/category'),
            array(
     ...
     *
     * @param EM_Blog_Model_Resource_Category_Collection $collection
    ...
    protected function _getIsActiveAttributeId()
    {
        ...
        if (is_null($this->_isActiveAttributeId)) {
            $bind = array(
                'entity_type_code' => EM_Blog_Model_Category::ENTITY,
    ...
    protected function _getInactiveItemIds($collection, $storeId)
    {
        ...
        $table = Mage::getSingleton('core/resource')->getTableName(array('blog/category', 'int'));
        $bind = array(
    ...
    public function move($category, $newParent, $prevNode = null)
    {
        ...
        Mage::getResourceSingleton('blog/category')->move($category->getId(), $newParent->getId());
    ...
    {
        Mage::app()->cleanCache(array(EM_Blog_Model_Category::CACHE_TAG));
    ...
    protected function _createCollectionDataSelect($sorted = true, $optionalAttributes = array())
    {
        ...
        foreach ($attributes as $attributeCode) {
            ...
            $attribute = Mage::getResourceSingleton('blog/category')->getAttribute($attributeCode);
        ...
        $categoriesTable         = Mage::getSingleton('core/resource')->getTableName('blog/category');
        $categoriesProductsTable = Mage::getSingleton('core/resource')->getTableName('blog/category_post');
